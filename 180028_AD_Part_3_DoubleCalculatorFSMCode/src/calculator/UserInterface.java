 ...
 * @version 4.1  	2019-01-21 Implementation of Subtraction, Multiplication and Division
 * @version 4.2     2019-02-19 Implementation of the Double Calculator with Log base 2
 * @version 4.3     2019-03-22 Implementation of FSM to provide more accurate error message
 * 
 * * <Team Definition> Neaz was suppose to Included the Logic for FSM in the state 5,6 and 7 properlyand work with me
 * on both operands to shown error message in appropriate position. 
 * I have worked on the entire FSM logic to show more accurate error message for both operands.
 * 
 * 
 */
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Label label_IntegerCalculator = new Label("Double Calculator with FSM");
	...
	private Button button_log = new Button("Log\u2082");    //This the button of log base to.
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		setupLabelUI(label_errOperand1, "Arial", 14,  
						Calculator.WINDOW_WIDTH-150-10, Pos.BASELINE_LEFT, 20, 126);	
		...
		setupLabelUI(label_errOperand2, "Arial", 14,  
						Calculator.WINDOW_WIDTH-150-10, Pos.BASELINE_LEFT, 20, 212);	
		...
		theRoot.getChildren().addAll(label_IntegerCalculator, label_Operand1, text_Operand1, label_errOperand1, 
				...
				button_Add, button_Sub, button_Mpy, button_Div,button_log,errMeasuredValue,errMeasuredValue1);
	...
	**********************************************************************************************/
	...
	private void setOperand1() {
		...
		if (perform.setOperand1(text_Operand1.getText())) {	
			label_errOperand1.setText("");			        // Set the operand and see if there was an error
	...
	//This is the logic to provide error message for operand1 measuredValue. It calls the CalculatorValue class 
	...
	//This is the logic to provide error message for operand2 measuredValue. It calls the CalculatorValue class
	...
	private void logOperands(){
		...
		label_errResult.setText("");									// Reset any result error messages from before
		if (theAnswer.length() > 0) {	
			text_Operand2.setText("");            // Check the returned String to see if it is okay
			text_Result.setText(theAnswer);							// If okay, display it in the result field and
