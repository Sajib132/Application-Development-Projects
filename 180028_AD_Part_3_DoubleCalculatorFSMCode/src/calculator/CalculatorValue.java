 ...
 * @version 4.1     2019-01-20 Implementation of Subtraction, Multiplication and Division
 * @version 4.2     2019-02-17 Implementation of the Double Calculator with Log base 2
 * @version 4.3     2019-03-22 Implementation of double FSM to provide more accurate error message
 * 
 * * <Team Definition> Neaz was suppose to Included the Logic for FSM in the state 5,6 and 7 properly and work with me
