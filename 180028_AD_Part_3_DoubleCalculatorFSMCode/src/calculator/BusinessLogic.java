...
public class BusinessLogic {
	...
	**********************************************************************************************/
	...
	public String division() {
		result = new CalculatorValue(operand1);        //This is the business logic for Division. If the second operand is Zero,
	...
	public String log() {
		result = new CalculatorValue(operand1);               //This is the business logic for Logarithm. While performing log operator
		result.log(operand1);                               // it will take the first operand only.
		resultErrorMessage = result.getErrorMessage();
		return result.toString();
	}
