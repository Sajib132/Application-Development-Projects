 ...
 * @version 4.2  2019-02-12 Implementation of a Double calculator with Log base 2
 */

public class Calculator extends Application {
	
	public final static double WINDOW_WIDTH = 750;
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Lynn Robert Carter, Sajib Biswas & Neaz Morshed");				
