 ...
 * @version 4.1  2019-01-16 The mainline of a JavaFX-based GUI implementation of a long integer calculator
 */
...
public class Calculator extends Application {
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Sajib Biswas");				//Changed the title to 'Sajib Biswas'
