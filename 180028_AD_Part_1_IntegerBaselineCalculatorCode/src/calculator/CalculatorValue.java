...
public class CalculatorValue {
	...
	**********************************************************************************************/
	...
	public void sub(CalculatorValue v) {
		measuredValue-=v.measuredValue; //Changed the logic.This logic perform the subtraction between two operand 
		errorMessage = "";//Removed the error message and subtraction has implemented.
	}

	public void mpy(CalculatorValue v) {
		measuredValue*=v.measuredValue; //Changed the logic.This logic perform the multiplication between two operand
		errorMessage = "";//Removed the error message and multiplication has implemented.
	}

	public void div(CalculatorValue v) {
		
		measuredValue/=v.measuredValue; //Changed the logic.This logic perform the division between two operand
		errorMessage = "";//Removed the error message and division has implemented.
		}
