...
public class BusinessLogic {
	...
	**********************************************************************************************/
	...
	public String subtraction() {
		...
		resultErrorMessage = result.getErrorMessage();
		return result.toString();
		// replaced this comment with the code required to compute the result. 
		//This code perform subtraction between two operand
	...
	public String multiplication() {
		...
		return result.toString();
		// replaced this comment with the code required to compute the result.
		//This code perform multiplication between two operand
	...
	public String division() {
		...
		return result.toString();
		// replaced this comment with the code required to compute the result.
		//This code perform division between two operand
