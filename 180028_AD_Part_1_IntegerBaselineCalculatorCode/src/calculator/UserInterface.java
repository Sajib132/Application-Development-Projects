 ...
 * @version 4.1     2019-01-23 he JavaFX-based GUI for the implementation of a calculator
 */
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Button button_Mpy = new Button("\u00d7");				// The symbol has been changed by multiply symbol: \u00D7
	private Button button_Div = new Button("\u00f7");				// The symbol has been changed by divide symbol: \u00F7
	...
	**********************************************************************************************/
	...
	private void subOperands(){
		// Check to see if both operands are defined and valid
				...
				if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
					text_Result.setText(theAnswer);							// If okay, display it in the result field and
					label_Result.setText("Difference");								// changed the title of the field to "Difference"
				}
		...
		// Replaced this line with the code. This code work for the subtraction
													}
	...
	private void mpyOperands(){
			...
			if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
				text_Result.setText(theAnswer);							// If okay, display it in the result field and
				label_Result.setText("Product");								// changed the title of the field to "Product"
			}
			else {														// Some error occurred while doing the multiplication.
				text_Result.setText("");									// Do not display a result if there is an error.				
				label_Result.setText("Result");							// Reset the result label if there is an error.
				label_errResult.setText(perform.getResultErrorMessage());	// Display the error message.
			}	// Replaced this line with the code. This code work for the multiplication
	...
	private void divOperands(){
			...
			if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
				text_Result.setText(theAnswer);							// If okay, display it in the result field and
				label_Result.setText("Quotient");								// changed the title of the field to "quotient"
			}
			else {														// Some error occurred while doing the division.
				text_Result.setText("");									// Do not display a result if there is an error.				
				label_Result.setText("Result");							// Reset the result label if there is an error.
				label_errResult.setText(perform.getResultErrorMessage());	// Display the error message.
			}		// Replaced this line with the code. This code work for the division
