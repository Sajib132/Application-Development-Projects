...
public class CalculatorValue {
	...
	**********************************************************************************************/
	...
	public void add(CalculatorValue v) {
		...
		lb1=measuredValue - errorTerm;     //This logic perform the addition between two operands with error term
		...
		errorTerm=((ub1+ub2) - (lb1+lb2))/2;
		errorTerm= Math.round(errorTerm*10.0)/10.0;
		errorMessage = "";
	}
	...
	public void sub(CalculatorValue v) {
		double lb1,lb2,ub1,ub2;
		lb1=measuredValue - errorTerm;                 //This logic perform the subtraction between two operands with error terms
		ub1= measuredValue + errorTerm;
